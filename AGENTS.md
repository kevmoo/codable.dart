...
- **native**: `dart:convert` from the private `json-utf8` Dart SDK build
  (`kevmoo/sdk` branch `json-utf8-squash`).
...
`~/github/dart-sdk/core/agent-json-squash/sdk/out/ReleaseX64/dart-sdk`.
