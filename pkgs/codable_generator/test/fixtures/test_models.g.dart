...
extension type const _$PointSchema(int _value) {
  ...
  static final JsonKeyOptions options = JsonKeyOptions.of(const [nameX, nameY]);
  ...
  void _throwMissingFields() {
    ...
    if ((_value & _xBit) == 0) missing.add(nameX);
    if ((_value & _yBit) == 0) missing.add(nameY);
...
extension type const _$UserAccountSchema(int _value) {
  ...
  static final JsonKeyOptions options = JsonKeyOptions.of(const [
    nameId,
    nameEmailAddress,
    aliasEmailAddressEmail,
    aliasEmailAddressContactEmail,
    nameRole,
    nameTags,
    nameLocation,
  ]);
  ...
  void _throwMissingFields() {
    ...
    if ((_value & _emailAddressBit) == 0) missing.add(nameEmailAddress);
    if ((_value & _roleBit) == 0) missing.add(nameRole);
    throw CodableException(
...
extension type const _$AddressSchema(int _value) {
  ...
  void _throwMissingFields() {
    ...
    if ((_value & _streetBit) == 0) missing.add(nameStreet);
    throw CodableException(
...
extension type const _$EnterpriseSchema(int _value) {
  ...
  void _throwMissingFields() {
    ...
    if ((_value & _headquarterBit) == 0) missing.add(nameHeadquarter);
    throw CodableException(
...
void _$EnterpriseToWriter(Enterprise instance, JsonTokenWriter writer) {
  ...
  if (instance.branches.isNotEmpty) {
  ...
  if (instance.categories.isNotEmpty) {
  ...
  if (instance.headcountByDept.isNotEmpty) {
...
extension type const _$UserProfileCustomSchema(int _value) {
  ...
  void _throwMissingFields() {
    final missing = <String>[];
    if ((_value & _idBit) == 0) missing.add(nameId);
    if ((_value & _zipBit) == 0) missing.add(nameZip);
    throw CodableException(
...
void _$TeamToWriter(Team instance, JsonTokenWriter writer) {
  ...
  if (instance.nullableTags.isNotEmpty) {
